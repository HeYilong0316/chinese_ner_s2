...
# batchsize 10
# lstm+crf
export OUTPUT_DIR=../user_data/output_lstm_crf
...
# # idcnn+crf
# export OUTPUT_DIR=../user_data/output_idcnn_crf
...
# # layer+lstm+crf
# export OUTPUT_DIR=../user_data/output_layer_lstm_crf
...
# # layer+idcnn+crf
# export OUTPUT_DIR=../user_data/output_layer_idcnn_crf
