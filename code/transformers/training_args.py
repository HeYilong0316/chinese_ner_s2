...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    layer_weight_weight_decay: float = field(default=0., metadata={"help": "crf lr multiplier"})
    crf_learning_rate: float = field(default=0.001, metadata={"help": "crf lr multiplier"})
    crf_weight_decay: float = field(default=0., metadata={"help": "crf lr multiplier"})
    lstm_learning_rate: float = field(default=0.001, metadata={"help": "crf lr multiplier"})
    ...
    do_predict_dev: bool = field(default=False, metadata={"help": "Whether to run predictions on the dev set."})
